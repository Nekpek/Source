...
public class SlotNaturalisFurnace extends Slot
    {
        /** The player that is using the GUI where this slot resides. */
        private final EntityPlayer thePlayer;
        private int field_75228_b;

        public SlotNaturalisFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
            {
         ...
         * pickaxes, not ore and wood. Typically increases an internal count
         * then calls onCrafting(item).
         */
        @Override
