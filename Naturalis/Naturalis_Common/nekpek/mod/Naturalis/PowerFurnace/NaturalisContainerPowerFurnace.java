...
public class NaturalisContainerPowerFurnace extends Container
    {
        private final TileEntityNaturalisFurnace furnace;
        private int lastCookTime;
        private int lastBurnTime;
        private int lastItemBurnTime;

        public NaturalisContainerPowerFurnace(InventoryPlayer par1InventoryPlayer, TileEntityNaturalisFurnace par2TileEntityFurnace)
            {
                ...
                this.addSlotToContainer(new SlotNaturalisFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 22));
                this.addSlotToContainer(new SlotNaturalisFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 4, 116, 48));
                int i;
                            ...
                            if (par2 != 1 && par2 != 0)
                                {
                                    if (FurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null)
                                        ...
                                        if (TileEntityNaturalisFurnace.isItemFuel(itemstack1))
                                            {
