                ...
                if (biome instanceof BiomeGenDesert)
                    {
                        ...
                        new EsquireHerbGen(EsquireBlocks.EsquireHerbs.blockID, 0, 32).generate(world, random, Xcoord, Ycoord, Zcoord);

                    }
                if (biome instanceof BiomeGenTaiga || biome instanceof BiomeGenSnow)
                    {
                        Ycoord = random.nextInt(255);
                        new EsquireHerbGen(EsquireBlocks.EsquireHerbs.blockID, 1, 64).generate(world, random, Xcoord, Ycoord, Zcoord);
                    }
