...
import sdc.nekpek.Esquire.Blocks.BlockEsquirePowerFurnace;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EsquireFurnaceTileEntity extends TileEntity implements ISidedInventory
    {
        ...
        /**
         * The number of ticks that a fresh copy of the currently-burning item
         * would keep the furnace burning for
         */
        ...
        /**
         * Sets the given item stack to the specified slot in the inventory (can
         * be crafting or armor sections).
         */
        @Override
        ...
        public String getInvName()
            {
                return this.isInvNameLocalized() ? this.field_94130_e : "Powered Furnace";
            }

        /**
         * If this returns false, the inventory name will be used as an
         * unlocalized name, and translated into the player's language.
        ...
        public void readFromNBT(NBTTagCompound par1NBTTagCompound)
            {
                ...
                if (par1NBTTagCompound.hasKey("Powered Furnace"))
                    {
                        this.field_94130_e = par1NBTTagCompound.getString("Powered Furnace");
                    }
            }
        ...
        public void writeToNBT(NBTTagCompound par1NBTTagCompound)
            {
                ...
                if (this.isInvNameLocalized())
                    {
                        par1NBTTagCompound.setString("Powered Furnace", this.field_94130_e);
                    }
            }

        /**
         * Returns the maximum stack size for a inventory slot. Seems to always
         * be 64, possibly will be extended. *Isn't this more of a set than a
         * get?*
         */
        @Override
                ...
                if (!this.worldObj.isRemote)
                    {
                        ...
                        if (flag != this.furnaceBurnTime > 0)
                            {
                                flag1 = true;
                                BlockEsquirePowerFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                            }
                    }
        ...
        /**
         * Returns true if the furnace can smelt an item, i.e. has a source
        ...
        private boolean canSmelt()
            {
                ...
                if (this.furnaceItemStacks[0] == null && this.furnaceItemStacks[3] == null)
                ...
                else
                    {
                        ...
                        ItemStack itemstack2 = FurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[3]);
                        ...
                        if (!this.furnaceItemStacks[2].isItemEqual(itemstack))
                            return false;
                        if (!this.furnaceItemStacks[4].isItemEqual(itemstack2))
                            return false;
        ...
        /**
         * Turn one item from the furnace source stack into the appropriate
         * smelted item in the furnace result stack
         */
                ...
                if (this.canSmelt())
                    {
                        ...
                        if (this.furnaceItemStacks[2] == null && this.furnaceItemStacks[4] != null)
                            {
                                this.furnaceItemStacks[2] = itemstack.copy();
                                furnaceItemStacks[4].stackSize += itemstack2.stackSize;
                            }
                        else
                            if (this.furnaceItemStacks[2] != null && this.furnaceItemStacks[4] == null)
                                {
                                ...
                                if (this.furnaceItemStacks[2] == null && this.furnaceItemStacks[4] == null)
                                    ...
                                    if (this.furnaceItemStacks[2].isItemEqual(itemstack) || this.furnaceItemStacks[4].isItemEqual(itemstack2))
                                        {
                                            if (this.furnaceItemStacks[0] != null)
                                                {
                                                    furnaceItemStacks[2].stackSize += itemstack.stackSize;
        ...
        /**
         * Returns an array containing the indices of the slots that can be
         * accessed by automation on the given side of this block.
         */
        @Override
