...
public class EsquireFurnaceSlots extends Slot
    {
        /** The player that is using the GUI where this slot resides. */
        private final EntityPlayer thePlayer;
        private int field_75228_b;

        public EsquireFurnaceSlots(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
            {
