...
public class EsquirePowerFurnaceGui extends GuiContainer
    {
        private static final ResourceLocation field_110410_t = new ResourceLocation("Esquire:textures/gui/PowerFurnaceGui.png");
        private final EsquireFurnaceTileEntity furnaceInventory;

        public EsquirePowerFurnaceGui(InventoryPlayer par1InventoryPlayer, EsquireFurnaceTileEntity par2TileEntityFurnace)
            {
                super(new EsquirePowerFurnaceContainer(par1InventoryPlayer, par2TileEntityFurnace));
