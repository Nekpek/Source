...
public class BlockEsquireSaltOre extends Block
    {

        public static boolean fallInstantly = false;

        public BlockEsquireSaltOre(int par1, Material par2Material)
            {
        ...
        public void registerIcons(IconRegister iconRegister)
            {
                blockIcon = iconRegister.registerIcon("Esquire:SaltOre");
            }
