...
public class ItemEsquireSaltedMeat extends ItemFood
    {
        public static final String[] SaltNames = new String[] { "Beef", "Pork" };
        public static final String[] field_94595_b = new String[] { "Beef", "Pork" };
        private Icon[] field_94594_d;

        public ItemEsquireSaltedMeat(int par1, int par2, float par3, boolean par4)
            {
        ...
        public void registerIcons(IconRegister par1IconRegister)
            {
                ...
                for (int i = 0; i < field_94595_b.length; ++i)
                    {
                        this.field_94594_d[i] = par1IconRegister.registerIcon("Esquire:" + "Salted" + field_94595_b[i]);
                    }
            }
