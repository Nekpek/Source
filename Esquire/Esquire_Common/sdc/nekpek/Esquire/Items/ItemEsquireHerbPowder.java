...
public class ItemEsquireHerbPowder extends Item
    {

        private int HerbAmounts = BlockEsquireHerbs.HerbAmounts;
        private Icon[] field_94594_d;

        public ItemEsquireHerbPowder(int par1)
            {
                super(par1);
        ...
        public void registerIcons(IconRegister par1IconRegister)
            {
                ...
                for (int i = 0; i < HerbAmounts; ++i)
                    {
                        this.field_94594_d[i] = par1IconRegister.registerIcon("Esquire:" + BlockEsquireHerbs.HerbType[i] + " Powder");
                    }
            }
